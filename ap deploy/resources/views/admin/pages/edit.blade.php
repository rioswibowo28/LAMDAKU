...
@section('breadcrumbs')
    ...
    <li class="breadcrumb-item"><a href="{{ route('admin.pages.show', $page) }}">{{ $page->title }}</a></li>
    ...
    <div class="col-lg-8 mx-auto">
        <div class="content-card">
            <div class="card-header">
                <h5><i class="fas fa-edit me-2"></i>Edit Page</h5>
            </div>
            <div class="card-body">
                @if($errors->any())
                    ...
                    <div class="mb-4">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control" id="meta_description" name="meta_description" 
                                      rows="2" maxlength="160">{{ old('meta_description', $page->meta_description) }}</textarea>
                            <div class="form-text">
