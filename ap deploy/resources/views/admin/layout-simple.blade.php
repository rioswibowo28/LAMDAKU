...
<head>    <meta charset="UTF-8">
    ...
    <title>@yield('title', ($company->company_name ?? 'LAMDAKU') . ' Admin Dashboard')</title>      <!-- Favicon -->
...
<body>
    <div class="container-fluid">
        <div class="row">
            <!-- Sidebar -->
            <div class="col-md-3 col-lg-2 px-0">                <div class="sidebar">
                    <div class="logo-text">
                    ...
                    <nav class="nav flex-column mt-3">
                        ...
                        <a class="nav-link {{ request()->routeIs('admin.contacts.*') ? 'active' : '' }}" href="{{ route('admin.contacts.index') }}">
                            ...
                            @endif                        </a>                        <a class="nav-link {{ request()->routeIs('admin.organizational-structure.*') ? 'active' : '' }}" href="{{ route('admin.organizational-structure.index') }}">
                        ...
                        <a class="nav-link {{ request()->routeIs('admin.vision-mission-goal.*') ? 'active' : '' }}" href="{{ route('admin.vision-mission-goal.index') }}">
                            ...
                            Visi, Misi & Tujuan
                        </a>                        <a class="nav-link {{ request()->routeIs('admin.pages.*') ? 'active' : '' }}" href="{{ route('admin.pages.index') }}">
                      ...
                      <div class="mt-auto p-3">
                        <div class="text-center mb-3">
                            <div class="text-white-50">Logged as:</div>
    ...
    </div>    <!-- Bootstrap JS only -->    <script src="https://cdn.jsdelivr.net/npm/bootstrap@5.3.0/dist/js/bootstrap.bundle.min.js"></script>
