...
@section('title', 'Tambah Timeline - LAMDAKU Admin')
@section('page-title', 'Tambah Timeline Baru')
    ...
    <div class="col-lg-8 mx-auto">
        <div class="content-card">
            <div class="card-header">
                <h5><i class="fas fa-plus me-2"></i>Add New Timeline Event</h5>
            </div>
            <div class="card-body">
                @if($errors->any())
                ...
                <form action="{{ route('admin.timelines.store') }}" method="POST">
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="number" class="form-control" id="year" name="year" 
                                       value="{{ old('year', date('Y')) }}" min="1900" max="2100" required>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="title" name="title" 
                               value="{{ old('title') }}" required placeholder="Company milestone or achievement">
                        ...
                        <div class="border rounded p-3" style="background: #f8f9fa;">
                            <div class="timeline-item d-flex" id="timeline-preview">
                                ...
                                <div class="timeline-content">
                                    <div class="timeline-year text-primary fw-bold" id="preview-year">{{ date('Y') }}</div>
                                    <h6 class="timeline-title mb-1" id="preview-title">Event Title</h6>
                                    <p class="timeline-description text-muted mb-0" id="preview-description">Event description will appear here...</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="d-flex gap-2">
                        <button type="submit" class="btn btn-primary">
                            <i class="fas fa-save me-2"></i>Save Timeline Event
                        </button>
