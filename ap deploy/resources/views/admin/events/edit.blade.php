        ...
        <div class="col-12">
            <div class="d-flex justify-content-between align-items-center mb-4">
                <div>
                    ...
                    <p class="text-muted">Edit event: {{ $event->title }}</p>
                </div>
                <div>
                    ...
                    <div class="col-md-8">
                            ...
                            <div class="card-body">
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control @error('content') is-invalid @enderror" 
                                              ...
                                              placeholder="Tulis konten detail event...">{{ old('content', $event->content) }}</textarea>
                                    @error('content')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="card-body">
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="form-select @error('timezone') is-invalid @enderror" id="timezone" name="timezone">
                                        <option value="Asia/Jakarta" {{ old('timezone', $event->timezone) === 'Asia/Jakarta' ? 'selected' : '' }}>WIB (Asia/Jakarta)</option>
                                        <option value="Asia/Makassar" {{ old('timezone', $event->timezone) === 'Asia/Makassar' ? 'selected' : '' }}>WITA (Asia/Makassar)</option>
                                        <option value="Asia/Jayapura" {{ old('timezone', $event->timezone) === 'Asia/Jayapura' ? 'selected' : '' }}>WIT (Asia/Jayapura)</option>
                                    </select>
                                    @error('timezone')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control @error('address') is-invalid @enderror" 
                                              ...
                                              placeholder="Alamat lengkap lokasi event...">{{ old('address', $event->address) }}</textarea>
                                    @error('address')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                        ...
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                                <div class="mb-3">
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" id="requires_registration" 
                                               name="requires_registration" value="1" 
                                ...
                                <div id="registration-fields" style="display: {{ old('requires_registration', $event->requires_registration) ? 'block' : 'none' }};">
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                            ...
                                            @foreach($event->gallery as $index => $image)
                                                <div class="col-6 mb-2">
                                                    ...
                                                    <div class="form-check">
                                                        ...
                                                        <label class="form-check-label small" for="remove_gallery_{{ $index }}">
                                                            Hapus
                                                        </label>
                                                    </div>
                                                </div>
