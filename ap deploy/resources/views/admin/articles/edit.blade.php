    ...
    <div class="row">
        <div class="col-12">            <div class="d-flex justify-content-between align-items-center mb-4">
                <div>
                    ...
                    <p class="text-muted mb-0">Edit artikel: {{ $article->title }}</p>
                </div>
                <div>
            ...
            </div>            <form action="{{ route('admin.articles.update', $article) }}" method="POST" enctype="multipart/form-data" id="articleForm">
                @csrf
                @method('PUT')
                ...
                <div class="row">
                    ...
                    <div class="col-lg-8">                        <!-- Basic Information -->
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                                <div class="mb-3">
                                    <label for="title" class="form-label">Judul Artikel <span class="text-danger">*</span></label>                                    <input type="text" class="form-control @error('title') is-invalid @enderror" 
                                ...
                                <div class="mb-3">
                                    <label for="excerpt" class="form-label">Ringkasan</label>                                    <textarea class="form-control @error('excerpt') is-invalid @enderror" 
                        ...
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                                <div class="mb-3">
                                    <label for="meta_title" class="form-label">Meta Title</label>                                    <input type="text" class="form-control @error('meta_title') is-invalid @enderror" 
                                ...
                                <div class="mb-3">
                                    <label for="meta_description" class="form-label">Meta Description</label>                                    <textarea class="form-control @error('meta_description') is-invalid @enderror" 
                                ...
                                <div class="mb-3">
                                    <label for="meta_keywords" class="form-label">Meta Keywords</label>                                    <input type="text" class="form-control @error('meta_keywords') is-invalid @enderror" 
                                ...
                                <div class="mb-3">
                                    <label for="canonical_url" class="form-label">Canonical URL</label>                                    <input type="url" class="form-control @error('canonical_url') is-invalid @enderror" 
                                ...
                                <div class="mb-3">
                                    <label for="og_title" class="form-label">Open Graph Title (Media Sosial)</label>                                    <input type="text" class="form-control @error('og_title') is-invalid @enderror" 
                                ...
                                <div class="mb-3">
                                    <label for="og_description" class="form-label">OG Description</label>                                    <textarea class="form-control @error('og_description') is-invalid @enderror" 
                                              id="og_description" name="og_description" rows="3" 
                                              placeholder="Akreditasi klinik adalah proses penilaian eksternal terhadap klinik oleh lembaga independen, seperti Lembaga Akreditasi Fasilitas Kesehatan Tingkat Pertama">{{ old('og_description', $article->og_description) }}</textarea>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="file" class="form-control @error('og_image') is-invalid @enderror" 
                                           id="og_image" name="og_image" accept="image/*">                                    @error('og_image')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                    @if($article->og_image)
                                        <div class="mt-2">
                                            <img src="{{ asset('storage/' . $article->og_image) }}" alt="Current OG Image" 
                                                 class="img-thumbnail" style="max-height: 100px;">
                                            <div class="form-text">Gambar OG saat ini. Upload file baru untuk menggantinya.</div>
                                        </div>
                                    @endif
                    ...
                    <!-- Sidebar -->                    <div class="col-lg-4">
                        ...
                        <div class="card mb-4">
                            ...
                            <div class="card-body">                                <div class="row text-center">
                                    <div class="col-4">
                                        ...
                                        <div class="h5 mb-0">{{ $article->view_count ?? 0 }}</div>
                                    </div>
                                    <div class="col-4">
                                        <div class="small text-muted">Read Time</div>
                                        <div class="h5 mb-0">{{ $article->read_time ?? 3 }} min</div>
                                    </div>
                                    <div class="col-4">
                                        <div class="small text-muted">Created</div>
                                        <div class="h5 mb-0">{{ $article->created_at->format('d M Y') }}</div>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                                <div class="mb-3">
                                    <label for="status" class="form-label">Status <span class="text-danger">*</span></label>                                    <select class="form-select @error('status') is-invalid @enderror" id="status" name="status" required>
                                ...
                                <div class="mb-3">
                                    <div class="form-check">                                        <input class="form-check-input" type="checkbox" id="is_featured" name="is_featured" value="1" 
                                ...
                                <div class="mb-3">
                                    <div class="form-check">                                        <input class="form-check-input" type="checkbox" id="allow_comments" name="allow_comments" value="1" 
                        ...
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                                <div class="mb-3">
                                    <label for="featured_image" class="form-label">Gambar Utama</label>                                    <div class="text-center mb-2" id="featured_image_preview">
                                    ...
                                    <input type="file" class="form-control @error('featured_image') is-invalid @enderror" 
                                           id="featured_image" name="featured_image" accept="image/*">                                    @error('featured_image')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                    @if($article->featured_image)
                                        <div class="form-text">Upload file baru untuk mengganti gambar saat ini</div>
                                    @endif
                        ...
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                                <div class="mb-3">
                                    <label for="category" class="form-label">Kategori</label>                                    <input type="text" class="form-control @error('category') is-invalid @enderror" 
                                ...
                                <div class="mb-3">
                                    <label for="tags" class="form-label">Tags</label>                                    <input type="text" class="form-control @error('tags') is-invalid @enderror" 
