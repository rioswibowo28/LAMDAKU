...
@section('title', 'Edit Struktur Organisasi - LAMDAKU Admin')
...
<div class="row">
    <div class="col-md-8">
        <div class="card">
            <div class="card-header">
                <h5><i class="fas fa-edit me-2"></i>Edit Posisi: {{ $organizationalStructure->name }}</h5>
            </div>
            <div class="card-body">                <form action="{{ route('admin.organizational-structure.update', $organizationalStructure) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <select class="form-select @error('level_order') is-invalid @enderror" 
                                    ...
                                    <option value="1" {{ old('level_order', $organizationalStructure->level_order) == '1' ? 'selected' : '' }}>
                                        Level 1 - Direktur Utama
                                    </option>
                                    <option value="2" {{ old('level_order', $organizationalStructure->level_order) == '2' ? 'selected' : '' }}>
                                        Level 2 - Direktur/Manager
                                    </option>
                                    <option value="3" {{ old('level_order', $organizationalStructure->level_order) == '3' ? 'selected' : '' }}>
                                        Level 3 - Manager/Supervisor
                                    </option>
                                    <option value="4" {{ old('level_order', $organizationalStructure->level_order) == '4' ? 'selected' : '' }}>
                                        Level 4 - Staff/Koordinator
                                    </option>                                    <option value="5" {{ old('level_order', $organizationalStructure->level_order) == '5' ? 'selected' : '' }}>
                                        Level 5 - Staff
                                    </option>
                                    <option value="6" {{ old('level_order', $organizationalStructure->level_order) == '6' ? 'selected' : '' }}>
                                        Level 6 - Junior Staff
                                    </option>
                                    <option value="7" {{ old('level_order', $organizationalStructure->level_order) == '7' ? 'selected' : '' }}>
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="number" 
                                       ...
                                       id="position_order" 
                                       name="position_order" 
                                       value="{{ old('position_order', $organizationalStructure->position_order) }}" 
                                       min="1"
                                       max="10">
                        ...
                        <textarea class="form-control @error('description') is-invalid @enderror" 
                                  ...
                                  name="description" 
                                  rows="3"
                                  placeholder="Contoh: Memimpin kebijakan strategis dan pengembangan organisasi">{{ old('description', $organizationalStructure->description) }}</textarea>
                        @error('description')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        @if($organizationalStructure->photo)
                            <div class="mb-2">
                                <img src="{{ $organizationalStructure->photo_url }}" alt="Current Photo" style="max-width: 150px; max-height: 150px; border-radius: 8px; border: 2px solid #ddd;">
                            ...
                            <div class="mb-3">
                                ...
                                <div class="input-group">
                                    <input type="color" 
                                           ...
                                           value="{{ old('background_color', $organizationalStructure->background_color) }}"
                                           style="width: 60px;">
                                    <input type="text" 
                                           class="form-control" 
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="text" 
                                       ...
                                       id="icon_class" 
                                       name="icon_class" 
                                       value="{{ old('icon_class', $organizationalStructure->icon_class) }}" 
    ...
    <div class="col-md-4">
        ...
        <div class="card mt-3">
            ...
            <div class="card-body">                <div id="preview-card" class="org-card-preview text-center p-3" style="background-color: {{ $organizationalStructure->background_color }}; border: 2px solid #90caf9; border-radius: 12px;">
                    @if($organizationalStructure->photo)
                        <div class="preview-photo mb-2" id="preview-photo-container">
                            <img id="preview-photo" src="{{ $organizationalStructure->photo_url }}" alt="Preview" style="width: 80px; height: 80px; border-radius: 50%; object-fit: cover; border: 3px solid #1976d2;">
                        </div>
                        <div class="preview-icon mb-2" id="preview-icon-container" style="display: none;">
                            <i id="preview-icon" class="{{ $organizationalStructure->icon_class }} fa-2x" style="color: #1976d2;"></i>
                        </div>
                    @else
                    ...
                    @endif
                    <h6 id="preview-position" class="fw-bold text-primary mb-1">{{ $organizationalStructure->position }}</h6>
                    <p id="preview-name" class="mb-1 text-dark">{{ $organizationalStructure->name }}</p>
                    <small id="preview-description" class="text-muted">{{ $organizationalStructure->description ?: 'Deskripsi...' }}</small>
                </div>
            </div>
        </div>
    </div>
...
function previewPhoto(input) {
    ...
    if (input.files && input.files[0]) {
        ...
        // Hide preview if no file selected, show original photo if exists
