...
class VisionMissionGoalSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $missions = [
            [
                'title' => 'Memberikan layanan akreditasi berkualitas tinggi sesuai standar internasional',
                'content' => 'Memberikan layanan akreditasi berkualitas tinggi sesuai standar internasional',
                'icon_class' => 'fas fa-check-circle',
                'sort_order' => 1
            ],
            [
                'title' => 'Meningkatkan kompetensi dan profesionalisme tenaga kesehatan',
                'content' => 'Meningkatkan kompetensi dan profesionalisme tenaga kesehatan',
                'icon_class' => 'fas fa-user-graduate',
                'sort_order' => 2
            ],
            [
                'title' => 'Mengembangkan sistem manajemen mutu yang berkelanjutan',
                'content' => 'Mengembangkan sistem manajemen mutu yang berkelanjutan',
                'icon_class' => 'fas fa-cogs',
                'sort_order' => 3
            ],
            [
                'title' => 'Memberikan konsultasi dan pendampingan terbaik kepada klien',
                'content' => 'Memberikan konsultasi dan pendampingan terbaik kepada klien',
                'icon_class' => 'fas fa-hands-helping',
                'sort_order' => 4
            ],
            [
                'title' => 'Melakukan inovasi berkelanjutan dalam metodologi akreditasi',
                'content' => 'Melakukan inovasi berkelanjutan dalam metodologi akreditasi',
                'icon_class' => 'fas fa-lightbulb',
                'sort_order' => 5
            ],
            [
                'title' => 'Membangun kemitraan strategis dengan stakeholder kesehatan',
                'content' => 'Membangun kemitraan strategis dengan stakeholder kesehatan',
        ...
        $goals = [
            [
                ...
                'content' => 'Memberikan setlap fasilitas kesehatan yang lulus akan memberikan pelayanan terbaik kepada masyarakat',
